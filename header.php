    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 bg-secondary d-none d-lg-block">
                <a href="<?php echo home_url();?>" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                    
                    <img src="<?php echo $cleanPRO['home_logo']['url'];?>" alt="website logo">
                </a>
            </div>
            <div class="col-lg-9">
